...
open class GenerateNavProguardTask : DefaultTask() {
    ...
    fun generate() {
        ...
        if (keepClasses.isNotEmpty()) {
            proguardFile.appendText(COMMENT)
            proguardFile.appendText(keepClasses.distinct().joinToString(separator = "\n"))
        }
    }

    companion object {
        const val PROGUARD_FILE_NAME = "nav-proguard-rule.pro"
        private const val COMMENT = "# Generated by NavProguardGenerator gradle plugin\n"
    }
}
